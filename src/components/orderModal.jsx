...
export default function OrderModal(props) {
    ...
    return (
        ...
        <Modal
            ...
            >
                <div className="w-full min-h-full rounded-2xl bg-primary flex flex-col  ">
                    ...
                    <div className='w-full  flex flex-row flex-wrap text-secondary'>                            
                            ...
                            <div className='w-full sticky bottom-0 h-[70px] bg-[#7979b8] rounded-b-2xl flex flex-row justify-center items-center gap-2 '>
                                ...
                                className='bg-gray-500/75 hover:bg-gray-500 cursor-pointer transition-colors duration-300 text-white font-semibold px-4 py-2 rounded-md'>
                                    Cancel
                                </button>
                            </div>
